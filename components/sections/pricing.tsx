  ...
  return (
    <section id="pricing" className="section-reveal relative scroll-mt-24 px-5 py-10 md:px-8 md:py-16">
      <div className="mx-auto max-w-6xl">
          ...
          {pricingOptions.map((item, index) => (
            <article
              ...
              className={`premium-card h-full rounded-2xl border p-5 transition-all duration-500 ease-out hover:-translate-y-1 md:p-9 ${
                index === 1
                  ? "border-secondary/30 bg-[radial-gradient(circle_at_18%_12%,rgba(144,180,206,0.14),transparent_34%),linear-gradient(145deg,rgba(255,255,255,0.62)_0%,rgba(238,246,251,0.56)_100%)]"
                  : "border-border/48 bg-[linear-gradient(145deg,rgba(255,255,255,0.58)_0%,rgba(247,251,255,0.46)_100%)]"
              }`}
            >
              <div className="flex min-h-full flex-col">
                ...
                <GoalLink
                  ...
                  href="#contact"
                  goal="click_pricing_cta"
                  goalParams={{ format: item.title }}
                >
                  Записаться
                </GoalLink>
              </div>
        ...
        <div className="relative mx-auto mt-7 max-w-5xl overflow-hidden rounded-2xl border border-secondary/18 bg-[radial-gradient(circle_at_14%_8%,rgba(255,255,255,0.58),transparent_34%),linear-gradient(135deg,rgba(255,255,255,0.54)_0%,rgba(247,251,255,0.58)_58%,rgba(234,243,248,0.5)_100%)] px-6 py-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.66),0_16px_48px_rgba(9,64,103,0.038)] backdrop-blur md:px-8 md:py-6">
